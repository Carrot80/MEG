...
for i= 1:size(nameFolds)
   ...
   kh_reduceERF2Brain( strcat(ControlsFolder, filesep, nameFolds{i,1}), nameFolds{i}, .2, .31) 
   kh_reduceERF2Brain( strcat(ControlsFolder, filesep, nameFolds{i,1}), nameFolds{i}, .2, .6) 

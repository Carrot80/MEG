...
function for_all (Folder, group, Task)
   ...
   [Table]=findextrema(strcat(Folder, filesep, nameFolds{i,1}), nameFolds{i}, Table, i, Task)  
    ...
    Path=strcat('/home/kh/ShareWindows/data/Extrema_and_Locations_fMRI_t-values_', group, '_', Task, '_ROIs.mat')
    save(Path, 'Table')
...
PathMask = strcat ('/home/kh/ShareWindows/data/patients/ROIs_complete_fMRI+tlrc');

 
    eval(['!3dExtrema -volume -average -mask_file ', PathMask, ' wspmT_0001+tlrc > Extrema_ROIs.txt'])
       
[Table, Mask]=kh_Whereami (SubjectPath, SubjectName, Table, i, 'ROIs', 1)

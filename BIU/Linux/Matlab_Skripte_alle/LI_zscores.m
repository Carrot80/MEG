...
% function created textfiles for Maxvalue in ROI, zum Ausrechnen des LI's
    ...
    LI_ALL_voxelvalues=zeros(24, 16)
    ...
    TimeInt = [.32, .6];
       ...
       [LI_ALL_voxelvalues]= kh_extractActROI(strcat(ControlsFolder, filesep, nameFolds{i,1}), nameFolds{i}, 'Broca_left_dil', 'Broca_right_dil', 'Broca', TimeInt, i, LI_ALL_voxelvalues, 1:4, 9:12)
       [LI_ALL_voxelvalues]= kh_extractActROI(strcat(ControlsFolder, filesep, nameFolds{i,1}), nameFolds{i}, 'Wernicke_left_dil', 'Wernicke_right_dil', 'Wernicke', TimeInt, i , LI_ALL_voxelvalues, 5:8, 13:16)
...
%       
    ...
    Path_LI_All_noise=strcat('/home/kh/ShareWindows/data/', filesep, 'patients', 'LI_All_voxelvalues_noise')
    save (Path_LI_All_noise, 'LI_ALL_voxelvalues')

end

function [LI_ALL_voxelvalues]=kh_extractActROI (SubjectPath, SubjectName, ROI_left, ROI_right, ROI, TimeInt, i, LI_ALL_voxelvalues, A, B)
...
LI_Path=strcat(SubjectPath, filesep, 'LI_', ROI, '_Voxelvalue_noise_', num2str(TimeInt(1,1)),'_', num2str(TimeInt(1,2)),'ms.mat')
save (LI_Path, 'LI') 

LI_ALL_voxelvalues(i,A)= [LI.LI_Voxelvalue_p01 LI.LI_Voxelcount_p01 LI.Voxelcount_p01_LeftVox LI.Voxelcount_p01_RightVox ]
LI_ALL_voxelvalues(i,B)= [LI.LI_Voxelvalue_p001 LI.LI_Voxelcount_p001 LI.Voxelcount_p001_LeftVox LI.Voxelcount_p001_RightVox ]

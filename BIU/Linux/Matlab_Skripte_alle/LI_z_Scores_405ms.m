...
% function created textfiles for Maxvalue in ROI, zum Ausrechnen des LI's
    ...
    Path_LI_All_noise=strcat('/home/kh/ShareWindows/data/', filesep, 'LI_controls_', num2str(TimeInt(1)), 's_voxelvalues_noise.mat')
...
PathERF = strcat('br_z_transf_brain01ERF_noise_', num2str(TimeInt), 's_', SubjectName, '+tlrc');
...
LI_Path=strcat(SubjectPath, filesep, 'LI_', ROI, '_Voxelvalue_noise_', num2str(TimeInt),'ms.mat')
save (LI_Path, 'LI') 
...
LI_Path=strcat(SubjectPath, filesep, 'LI_', ROI, '_Voxelvalue_noise_', num2str(TimeInt(1)),'ms.mat')
save (LI_Path, 'LI') 
...
load(strcat(SubjectPath, filesep, 'LI_squared_noise__Broca_SumMax_0.32_0.47ms.mat'))
LI_All(1,3)=LI_SumMax;
clear LI_SumMax

load(strcat(SubjectPath, filesep,  'LI_squared_noise__Broca_SumMax_0.4_0.6ms.mat'))
LI_All(1,4)=LI_SumMax;
clear LI_SumMax


load(strcat(SubjectPath, filesep,   'LI_Max_squared_noise__Wernicke_0.32_0.6ms.mat'))
LI_All(1,5)=LI_Max_sqared;
clear LI_Max

load(strcat(SubjectPath, filesep, 'LI_squared_noise__Wernicke_SumMax_0.32_0.6ms.mat'))
LI_All(1,6)=LI_SumMax;
clear LI_SumMax

load(strcat(SubjectPath, filesep, 'LI_squared_noise__Wernicke_SumMax_0.32_0.47ms.mat'))
LI_All(1,7)=LI_SumMax;
clear LI_SumMax

load(strcat(SubjectPath, filesep,  'LI_squared_noise__Wernicke_SumMax_0.4_0.6ms.mat'))

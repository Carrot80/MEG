...
function for_all (Folder, group)
   ...
   [Table]=findextrema(strcat(Folder, filesep, nameFolds{i,1}), nameFolds{i}, Table, i, group)  
    ...
    Path=strcat('/home/kh/ShareWindows/data', filesep, 'Extrema_and_Locations_', group,'_ROIs_MEG_noise_abs.mat')
    save(Path, 'Table')
...
if 1==strcmp (SubjectName,'Pat_02_13008rh') ||  1==strcmp (SubjectName,'Pat_03_13014bg')
    ...
    eval(['!3dExtrema -volume -average -mask_file ', PathMask, ' br_z_transf_brain01ERF_noise_abs_0.32-0.6s_', SubjectName,'+tlrc > Extrema_ROIs_complete.txt'])

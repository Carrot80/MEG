...
% TruecryptFolder = '/media/truecrypt7/Linux_data/KeepTrialsNoNoiseEstimation/';
% DIR_Truecrypt = dir (TruecryptFolder);
% isub_truecrypt = [DIR_Truecrypt(:).isdir];
% nameFolds_truecrypt = {DIR(isub_truecrypt).name}';
...
%     VS2Brik(cfg,1e+13*abs(vs)); % =>creates ERF+orig.Brik+Head
    ...
    TruecryptFolder = strcat('/media/truecrypt7/Linux_data/KeepTrialsNoNoiseEstimation/', SubjectName);
    cd (TruecryptFolder)
